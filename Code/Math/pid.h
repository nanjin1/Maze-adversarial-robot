...
extern struct P_pid_obj gyroT_pid, gyroG_pid, small_gyroT_pid;
extern struct PID_param gyroT_pid_param, gyroG_pid_param, small_gyroT_pid_param;
...
void chage_target(uint16_t target);
